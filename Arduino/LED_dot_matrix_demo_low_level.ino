// โปรแกรมนี้เชื่อมต่อกับ LED Dot Matrix ขนาด 8x8 เพื่อแสดงการทำงานของฟังก์ชันระดับล่าง โดยจะ Write Register โดยตรง ไม่ได้ใช้ Library 
// โปรแกรมจะแสดงกระพริบ 2 ครั้ง และ แสดงตัวอักษร C กับ E สลับกันไป
